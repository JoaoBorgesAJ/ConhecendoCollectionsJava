...
public class ConjuntoConvidados {
    ...
    public static void main(String[] args) {
        // Criando uma instância da classe ConjuntosConvidados
        ...
        // Exibindo o número atualizado do conjunto por código de convite
        conjuntoConvidados.removerConvidadoPorCodigoConvite(1236);
        System.out.println("Existem" + conjuntoConvidados.contarConvidados()
                + "convidado(s) dentro do Set de Convidados após a remocão");

        // Exibindo os convidados atualizados no conjunto
        System.out.println("Convidados no conjunto após remocaõ: ");
        conjuntoConvidados.exibirConvidados();
    }
}